...
public class PoiUtils {
    ...
    public static ResponseEntity<byte[]> exportPatient2Excel(List<Patient> patients) {
        ...
        try {
            ...
            for (int i = 0; i < patients.size(); i++) {
                ...
                row.createCell(10).setCellValue(patient.getPhone());
                row.createCell(11).setCellValue(patient.getAddress());
                row.createCell(12).setCellValue(patient.getDepartment().getName());
                row.createCell(13).setCellValue(patient.getJobLevel().getName());
                row.createCell(14).setCellValue(patient.getPosition().getName());
                row.createCell(15).setCellValue(patient.getEngageForm());
                row.createCell(16).setCellValue(patient.getTiptopDegree());
                row.createCell(17).setCellValue(patient.getSpecialty());
                row.createCell(18).setCellValue(patient.getSchool());
                HSSFCell beginDateCell = row.createCell(19);
                beginDateCell.setCellValue(patient.getBeginDate());
                beginDateCell.setCellStyle(dateCellStyle);
                row.createCell(20).setCellValue(patient.getWorkState());
                row.createCell(21).setCellValue(patient.getEmail());
                row.createCell(22).setCellValue(patient.getContractTerm());
                HSSFCell beginContractCell = row.createCell(23);
                beginContractCell.setCellValue(patient.getBeginContract());
                beginContractCell.setCellStyle(dateCellStyle);
                HSSFCell endContractCell = row.createCell(24);
                endContractCell.setCellValue(patient.getEndContract());
    ...
    public static List<Patient> importPatient2List(MultipartFile file,
        ...
        case STRING: {
            ...
            switch (k) {
                ...
                case 7:
                    ...
                    patient.setNationId(allNations.get(nationIndex).getId());
                    break;
                case 8:
                    patient.setNativePlace(cellValue);
                    break;
                case 9:
                    int psIndex = allPolitics.indexOf(new PoliticsStatus(cellValue));
                    patient.setPoliticId(allPolitics.get(psIndex).getId());
                    break;
                case 10:
                    patient.setPhone(cellValue);
                    break;
                case 11:
                    patient.setAddress(cellValue);
                    break;
                case 12:
                    int depIndex = allDeps.indexOf(new Department(cellValue));
                    patient.setDepartmentId(allDeps.get(depIndex).getId());
                    break;
                case 13:
                    int jlIndex = allJobLevels.indexOf(new JobLevel(cellValue));
                    patient.setJobLevelId(allJobLevels.get(jlIndex).getId());
                    break;
                case 14:
                    int posIndex = allPos.indexOf(new Position(cellValue));
                    patient.setPosId(allPos.get(posIndex).getId());
                    break;
                case 15:
                    patient.setEngageForm(cellValue);
                    break;
                case 16:
                    patient.setTiptopDegree(cellValue);
                    break;
                case 17:
                    patient.setSpecialty(cellValue);
                    break;
                case 18:
                    patient.setSchool(cellValue);
                    break;
                case 19:
                case 20:
                    patient.setWorkState(cellValue);
                    break;
                case 21:
        ...
        default: {
            switch (k) {
                case 4:
                    patient.setBirthday(cell.getDateCellValue());
                    break;
                case 19:
                    patient.setBeginDate(cell.getDateCellValue());
                    break;
                case 22:
                    patient.setContractTerm(cell.getNumericCellValue());
                    break;
                case 23:
                    patient.setBeginContract(cell.getDateCellValue());
                    break;
                case 24:
                    patient.setEndContract(cell.getDateCellValue());
                    break;
            }
        }
            break;
